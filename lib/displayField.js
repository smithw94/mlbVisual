...
svg.append("circle").attr("r", 10).attr("cx", x(50)).attr("cy", y(30)).attr('class', 'bases').attr('fill', 'rgb(229, 211, 174)');
svg.append("circle").attr("r", 10).attr("cx", x(30)).attr("cy", y(30)).attr('class', 'bases').attr('fill', 'white');
svg.append("circle").attr("r", 10).attr("cx", x(70)).attr("cy", y(30)).attr('class', 'bases').attr('fill', 'white');
svg.append("circle").attr("r", 10).attr("cx", x(50)).attr("cy", y(50)).attr('class', 'bases').attr('fill', 'white');
svg.append("circle").attr("r", 10).attr("cx", x(50)).attr("cy", y(10)).attr('class', 'bases').attr('fill', 'white');
}